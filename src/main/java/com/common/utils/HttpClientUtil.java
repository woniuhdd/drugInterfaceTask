...
public class HttpClientUtil {
     ...
     * @return String
     */
    public static String doPostJson(String url, List<NameValuePair> data,Map<String, String> header) {
        // 创建Httpclient对象
        CloseableHttpClient httpClient = HttpClients.createDefault();
        CloseableHttpResponse response = null;
        String resultString = "";
        try {
            ...
            // 创建请求内容
            HttpEntity entity = new UrlEncodedFormEntity(data, Charset.defaultCharset());
            httpPost.setEntity(entity);
            // 执行http请求
            response = httpClient.execute(httpPost);
            resultString = EntityUtils.toString(response.getEntity(), "utf-8");
     ...
     * @return String
     */
    public static String doPostJsonAndHeader(String url, String json,String header) {
        // 创建Httpclient对象
        CloseableHttpClient httpClient = HttpClients.createDefault();
        CloseableHttpResponse response = null;
        String resultString = "";
        try {
            ...
            httpPost.setHeader("AccessToken",header);
            // 创建请求内容
            StringEntity entity = new StringEntity(json, ContentType.APPLICATION_JSON);
            httpPost.setEntity(entity);
            // 执行http请求
    ...
    public static void main(String[] args) {
        ...
        //System.out.println(JSON.parseObject(result).get("showapi_res_id"));
